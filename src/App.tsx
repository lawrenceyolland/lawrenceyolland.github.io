...
const App = () => {
    ...
    return (
        <div className="min-h-screen relative">
            ...
            <div className="hidden md:flex fixed top-14 left-0 w-1/2 h-[calc(100vh-3.5rem)] flex-col py-10 px-16 relative overflow-auto">
                <Title />
                <Bio />
                <div className="py-5 pr-10">
                    <a
                        href="/Lawrence_Yolland_Resume_2026.pdf"
            ...
            <div className="right-panel md:fixed md:top-14 md:right-0 md:w-1/2 md:h-[calc(100vh-3.5rem)] md:overflow-y-auto pt-14 md:pt-0">
                <div className="md:hidden py-10 px-8">
                    <Title />
                    <Bio />
                    {/*TODO: move resume downloader to own component*/}
                    <div className="py-5 pr-10">
                        <a
                            href="/Lawrence_Yolland_Resume_2026.pdf"
                            download="Lawrence_Yolland_Resume_2026.pdf"
